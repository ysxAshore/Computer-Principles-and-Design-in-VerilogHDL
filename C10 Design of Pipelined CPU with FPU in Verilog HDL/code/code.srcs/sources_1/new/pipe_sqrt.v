...
module pipe_sqrt(
    ...
    wire [7:0]wexp;
    wire [1:0]wrm;
    reg_design #(.WIDTH(64))r1(clk,e,clear,
    ...
    reg_design #(.WIDTH(114))r2(clk,e,clear,{sum,c,wisZero,wisNan,wisInf,wisNeg,wexp,wrm},{csum,cc,cisZero,cisNan,cisInf,cisNeg,cexp,crm});
    ...
    wire [7:0]nexp;
    wire [1:0]nrm;
    reg_design #(.WIDTH(64))r3(clk,e,clear,{q,cisZero,cisNan,cisInf,cisNeg,cexp,crm},{nq,nisZero,nisNan,nisInf,nisNeg,nexp,nrm});
    ...
    always @(*) begin
        ...
        if (clear) begin
            res=0;
        end else if(e)begin//当流水线不阻塞时才允许计算
            if (nisZero) begin
