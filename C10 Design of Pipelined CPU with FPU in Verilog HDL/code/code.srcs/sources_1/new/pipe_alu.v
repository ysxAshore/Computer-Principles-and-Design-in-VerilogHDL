...
module pipe_alu(
    ...
    wire [7:0]ctemp_e;
    wire [1:0]ccrm;
    reg_design #(.WIDTH(182))align_cal(clk,e,clear,{op_sub,isNan,isInf,sign,aligned_large_frac,aligned_small_frac,nan_frac,inf_frac,
    ...
    wire [1:0]ncrm;
    wire [27:0]ncal_frac;
    reg_design #(.WIDTH(153))cal_normal(clk,e,clear,{cisNan,cisInf,csign,cnan_frac,cinf_frac,
