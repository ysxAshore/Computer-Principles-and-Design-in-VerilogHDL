...
module pipe_fmul_top(
    ...
    wire [47:0]asum,ac;
    wire [1:0]arm;
    reg_design #(.WIDTH(139)) partical_add(clk,1,0,{aisinf,aiszero,aisnan,bisinf,biszero,bisnan,nan_frac,sign,temp_e,sum,c,rm},
    ...
    wire [47:0]nres;
    wire [1:0]nrm;
    reg_design #(.WIDTH(91)) add_normal(clk,1,0,{aaisinf,aaiszero,aaisnan,abisinf,abiszero,abisnan,anan_frac,asign,atemp_e,res,arm},
